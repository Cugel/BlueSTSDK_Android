...
data class SubSensorStatusParam private constructor(
    ...
    companion object {
        ...
        fun buildSamplePerTSParam(samplesPerTs: Int) = SubSensorStatusParam(samplesPerTs = samplesPerTs)
...
data class HSDCmd private constructor(
    ...
    companion object {
        ...
        fun buildHSDSetCmdSensor(sensorId: Int, subSensorStatus: List<SubSensorStatusParam>) = HSDCmd(
            command = "SET",
            request = null,
            sensorId = sensorId,
        ...
        fun buildHSDSetCmdMLCSensor(sensorId: Int, subSensorStatus: List<SubSensorStatusParam>) = HSDCmd(
            command = "SET",
            request = "mlc_config",
            sensorId = sensorId,
            subSensorStatus = subSensorStatus
        ...
        fun buildHSDSetCmdSTREDLSensor(sensorId: Int, subSensorStatus: List<SubSensorStatusParam>) = HSDCmd(
            command = "SET",
