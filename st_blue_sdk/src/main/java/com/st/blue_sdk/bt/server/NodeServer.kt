...
class NodeServer(
    ...
    fun isEnabled() = exportedServicesWithFeatures.flatMap { it.value }.find { it.isEnabled } != null
    ...
    private inner class ServerGattCallback : BluetoothGattServerCallback() {
        ...
        override fun onDescriptorWriteRequest(
            ...
            descriptor?.characteristic?.let { bleGattChar ->
                ...
                Log.d(TAG, "Char: $bleGattChar -> isEnabled:${isEnabled}")
